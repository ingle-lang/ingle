// math_bench.ig — exercises Ingle's arithmetic and doubles as a speed benchmark.
//
...
// results stay within Ingle's checked 64-bit range — overflow traps rather than
...
//     time ./build/inglec --emit=run benchmarks/math_bench.ig
