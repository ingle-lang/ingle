// flex_bench.ig — the whole-language speed benchmark. One run exercises every
...
//   8. recursion — naive fib(30), the cross-benchmark anchor (see math_bench.ig)
//
// Run it timed:   make bench        (or)
//                 time ./build/inglec-release --emit=run benchmarks/flex_bench.ig
