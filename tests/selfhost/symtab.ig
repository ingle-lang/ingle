// tests/selfhost/symtab.ig — Stage A self-hosting spike (docs/design/self-hosting.md §4 "Stage A",
...
// with shadowing. This spike builds all three in pure Ingle and drives them at the scale a real checker
