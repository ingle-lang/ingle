...
// CONVERSIONS — two pieces surfaced by dogfooding the real lexer through cgen_c.ig. (1) `+` CONSUMES its
...
// re-boxed on read. Byte-identical to stage-0 `inglec --emit=c` (gated, Stage 6 of make selfhost).
