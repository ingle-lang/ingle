// channel_refcount.ig (parallel variant) — stresses the CROSS-THREAD half of channel reference
// counting, which the serial golden (tests/run/channel_refcount.ig) cannot reach. Eight producers
