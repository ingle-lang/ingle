// Regression for the self-hosted checker (selfhost/checker.ig) M3b mutability + structural checks
// (2026-06-27). Every construct here is VALID Ingle that stage-0 accepts, so the self-hosted checker
