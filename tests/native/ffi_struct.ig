// ffi_struct.ig — FFI structs by value (3b.6, the C ABI). An all-scalar Ingle struct passed to
...
// (sin/cos etc. — the scalar slice — share the same OP_CALL_C path; see ffi_libm.ig.)
struct Vec2 {
    x: f64
    y: f64
}
