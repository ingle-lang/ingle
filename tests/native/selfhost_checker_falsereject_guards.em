// Regression for the self-hosted checker (selfhost/checker.em) false-reject family triaged 2026-06-27.
//
// Two distinct leniency holes were closed; every construct below is VALID Ember that stage-0 accepts,
