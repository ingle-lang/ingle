// move_self_consume.ig — a `move self` method CONSUMES its receiver (OFI-145 / R5p2). The receiver
// binding is marked moved (use-after-move is a compile error — see tests/run/error_move_self_after_move.ig)
