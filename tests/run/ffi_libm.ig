// ffi_libm.ig — the foreign function interface (MANIFESTO §5h). An `extern "c"` block declares
// C functions by their Ingle-side signature; calls then look like any call and dispatch through
