// discard_wildcard.ig — `_` is a discard wildcard (OFI-095). A bare `_` binding may be
...
// error (see error_discard_read.ig); discarding a linear Ptr still errors (error_discard_ptr_leak.ig).
