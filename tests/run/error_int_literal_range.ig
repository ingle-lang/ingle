// error_int_literal_range.ig — locks REVIEW_FINDINGS M14: an integer LITERAL whose digits exceed
// i64 is a compile error, not a silent clamp. 9223372036854775808 is i64 max + 1. (Distinct from
// error_int_overflow.ig, which traps at RUNTIME on arithmetic; this is caught at parse time.)
