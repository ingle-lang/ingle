// wrapping_arith.ig — wrapping (modulo 2^width) integer arithmetic (OFI-041). The default
...
// FNV-1a, in pure Ingle — the motivating use case (was impossible without wrapping multiply).
