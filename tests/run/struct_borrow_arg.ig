// struct_borrow_arg.ig — a value-struct local passed BY BORROW (used again, so NOT moved) to a
...
// (Run under build/inglec-asan to confirm memory-safety; the golden locks the executed result.)
struct Pt {
    x: int
    y: int
    z: int
