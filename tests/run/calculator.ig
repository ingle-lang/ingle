// calculator.ig — integration regression for the expression evaluator (the full
// showcase lives in examples/06_calculator.ig). Tokenize → recursive-descent parse
