// error_escape_borrow.ig — returning a borrowed parameter would let a reference escape the
...
// copy type and may be returned by value (see struct_return_copy_param.ig / OFI-028).
