// ffi_pointers.ig — pointer/buffer FFI (§5h pointers). Exercises all three pointer leaf kinds:
...
//   'P' opaque Ptr   — a FILE* handle that round-trips through Ingle (fopen → … → fclose)
