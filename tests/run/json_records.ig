// tests/run/json_records.ig — regression for the DESERIALIZE pattern flare_chat's persistence uses: parse a
...
// serialization). JSON braces/quotes are escaped `\{ \} \"` (Ingle's `{` opens interpolation, `"` ends a string).
