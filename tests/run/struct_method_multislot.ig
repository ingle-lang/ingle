// struct_method_multislot.ig — value-types 3b.4d: a method on a NON-generic struct takes its
...
// bounded generic code) — covered by bounded_generic.ig. A double-free would corrupt the sum.
struct Pt {
    x: int
    y: int
