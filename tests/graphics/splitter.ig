// tests/graphics/splitter.ig — regression for the draggable resize/split control (std/ui _split_drag, the
...
// deterministic WITHOUT a real mouse (input injected like text_field.ig). It pins the load-bearing logic:
