// tests/graphics/flare_code_select.ig — regression for SELECTABLE code blocks: a fenced code panel whose
...
// selects like every editor's. Input is injected (focus + buf + selection set directly, like text_field.ig)
