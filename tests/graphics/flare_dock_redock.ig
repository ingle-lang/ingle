// tests/graphics/flare_dock_redock.ig — regression for DRAG-A-TITLE-BAR-TO-REDOCK (std/flare _dock_drag /
// _dock_drop / redock / dock_root_edge). Where flare_dock_ui.ig drives divider-drag + close, this drives the
