// tests/graphics/flare_rich.ig — regression for std/flare's inline rich text (f.markdown → rich_text).
...
// re-blessing on another machine (`tests/run-graphics.sh --update`), like its sibling flare.ig — the
