// tests/graphics/text_field.ig — regression for text_field horizontal scroll (OFI-055). A value
...
// so the caret stays inside. Input is injected (focus/buf/caret set directly, like scroll.ig) so
