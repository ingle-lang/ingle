// tests/graphics/flare_textarea.ig — regression for the multi-line text_area (std/ui _ta_edit/_ta_draw +
// _wrap_lines, wrapped by std/flare). A value with a long WRAPPING line plus a hard newline renders as
// several visual lines; focusing it (state injected directly, like text_field.ig) shows the accent ring and
