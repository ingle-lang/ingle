// tests/graphics/flare_modal.ig — regression for std/flare's modal + segmented + divider, which rest on
...
// flare.ig — the shape ops (scrim, panel, divider, accent fills) are the stable part being asserted.
