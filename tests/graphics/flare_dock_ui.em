// tests/graphics/flare_dock_ui.em — regression for the INTERACTIVE dock (std/flare dock_begin / dock_panel /
// _dock_divider / the close ✕). Where flare_dock.em covers the pure DockTree data model and flare_dock_solve.em
// its geometry, this drives the RENDERER + interaction: it injects mouse state (like flare_splitter.em) and
