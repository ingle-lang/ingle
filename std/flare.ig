// std/flare — declarative, component-style UI for Ingle (MANIFESTO §5g), now with a REAL flexbox
...
// only because the real DOM is retained and slow to mutate; Ingle redraws every frame cheaply, so
