...
// Ingle `enum` (a sum type) so rendering is one exhaustive `match` — the language's own machinery doing
// exactly what it's for. Reusable by any Ingle GUI: chat transcripts, docs viewers, note apps. This is
