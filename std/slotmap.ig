// std/slotmap.ig — a generic generational-arena SlotMap<V>, written in Ingle. The store owns the
...
//
// There is no in-place `get_mut`: Ingle has no interior mutability, so to change a stored value you
