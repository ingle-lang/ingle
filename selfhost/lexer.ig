// selfhost/lexer.ig — the Ingle lexer, written in Ingle (Stage 1 of the self-hosting bootstrap,
...
// driver is selfhost/lex_dump.ig, whose output is diffed against `inglec --emit=tokens` over the whole
...
// parser calls this, then matches the tokens). The dump driver lives in selfhost/lex_dump.ig.
