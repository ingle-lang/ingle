// gui.ig — a Claude Desktop look-alike written in Ingle (Phase 2 of the acid test).
//
// The transport is the one C library Ingle borrows (libcurl, via `http_post`); the GUI is the
// raylib immediate-mode backend (window_open / frame_begin / fill_round / draw_text / …). Every
// pixel of layout and all of the JSON handling are pure Ingle.
//
//   make net-graphics
