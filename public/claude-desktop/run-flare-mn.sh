...
#
# Sibling of run-flare.sh, which uses the proven 1:1 thread-per-fiber build (build/inglec-net-gfx).
...
exec build/inglec-mn-net-gfx --emit=run public/claude-desktop/flare_chat.ig
