...
| OFI-198 | **Auto-derived structural equality** — `==` on a struct is a compile error today, yet LLMs write it constantly. Derive *structural equality only* (not general operator overloading). Design-gated. See [ergonomics-campaign](design/ergonomics-campaign.md). | OPEN |
...
*Phase 1b of the [ergonomics & ecosystem campaign](design/ergonomics-campaign.md). Opened & closed same day.*
...
*Phase 1a of the [ergonomics & ecosystem campaign](design/ergonomics-campaign.md). Opened & closed same day.*
