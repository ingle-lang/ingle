...
[manifesto](https://github.com/ingle-lang/ingle-lang/blob/main/MANIFESTO.md) found while building Ingle. Raise here instead of coding around them.
...
*Built in two stages over the live `inglec` (design: [docs/design/newtypes-refinements.md](https://github.com/ingle-lang/ingle-lang/blob/main/docs/design/newtypes-refinements.md)). Both backends; 412/0, all 7 verify gates, ASan clean.*
...
*Built over OFI-149 newtypes (design: [docs/design/newtypes-refinements.md](https://github.com/ingle-lang/ingle-lang/blob/main/docs/design/newtypes-refinements.md)). 421/0, all 7 verify gates, ASan clean.*
...
*The first concrete deliverable of the self-hosting bootstrap ([docs/design/self-hosting.md](https://github.com/ingle-lang/ingle-lang/blob/main/docs/design/self-hosting.md)), Stage A.*
