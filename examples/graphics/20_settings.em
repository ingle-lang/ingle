// 20_settings.em — a non-trivial Flare screen: a SETTINGS DIALOG (MANIFESTO §5g). It answers the
...
//
//   make graphics && build/emberc-gfx --emit=run examples/graphics/20_settings.em
