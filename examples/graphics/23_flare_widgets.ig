// 23_flare_widgets.ig — Flare form controls (MANIFESTO §5g): a checkbox (pill toggle), a slider (drag the
...
//
//   make graphics && build/inglec-gfx --emit=run examples/graphics/23_flare_widgets.ig
