// 11_menus.ig — dropdown menus and tooltips (MANIFESTO §5g, Phase B3).
// Build and run:  make graphics && build/inglec-gfx --emit=run examples/11_menus.ig
//
...
// chosen, and the action is plain Ingle code. Two menu headers sit side by side via
...
fn main() -> int {
    draw.window(520, 360, "Ingle — menus & tooltips")
