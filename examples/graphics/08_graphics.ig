// 08_graphics.ig — Ingle reaches the screen (MANIFESTO §5g). Build the graphics
// compiler and run this to see a window:
//
//   make graphics
//   build/inglec-gfx --emit=run examples/08_graphics.ig
//
...
// Ingle code while the native backend renders it. The same ownership rules that make
// the rest of Ingle memory-safe apply here unchanged, because no graph-shaped UI
// state ever exists.

import "std/draw" as draw

fn main() -> int {
    draw.window(800, 600, "Ingle — move the square")
