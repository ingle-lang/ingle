// 17_flare.ig — std/flare: declarative, component-style UI with a REAL flexbox layout engine and a
// warm, Claude-inspired house look (MANIFESTO §5g). Build the graphics compiler and run:
//
//   make graphics && INGLE_STD=./std build/inglec-gfx --emit=run examples/17_flare.ig
//
