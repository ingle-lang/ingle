// 18_flare_anim.ig — Flare ANIMATION: spring physics + FLIP layout transitions (MANIFESTO §5g). Two
// techniques modern UIs lean on, made nearly free by immediate mode + Ingle's determinism:
//
...
//
//   make graphics && INGLE_STD=./std build/inglec-gfx --emit=run examples/graphics/18_flare_anim.ig
