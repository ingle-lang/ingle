// 22_flare_command_palette.ig — a ⌘K COMMAND PALETTE on Flare (MANIFESTO §5g). Press ⌘K (or Ctrl+K) to
...
//
//   make graphics && build/inglec-gfx --emit=run examples/graphics/22_flare_command_palette.ig
