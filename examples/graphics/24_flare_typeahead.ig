// 24_flare_typeahead.ig — a SLASH-COMMAND typeahead on Flare (MANIFESTO §5g), the Claude-Code "/" move.
...
//
//   make graphics && build/inglec-gfx --emit=run examples/graphics/24_flare_typeahead.ig
