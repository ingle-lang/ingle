// 09_ui.ig — immediate-mode widgets (MANIFESTO §5g). Build the graphics compiler and
// run it to interact:  make graphics && build/inglec-gfx --emit=run examples/09_ui.ig
//
...
fn main() -> int {
    draw.window(440, 460, "Ingle — immediate-mode UI")
