// 27_flare_dropfiles.ig — file drag-and-drop via the `dropped_files()` graphics native (MANIFESTO §5g).
...
//
//   make graphics && build/inglec-gfx --emit=run examples/graphics/27_flare_dropfiles.ig
