// 10_windows.ig — overlapping, draggable, z-ordered windows (MANIFESTO §5g, Phase B).
// Build and run:  make graphics && build/inglec-gfx --emit=run examples/10_windows.ig
//
...
fn main() -> int {
    draw.window(640, 480, "Ingle — overlapping windows")
