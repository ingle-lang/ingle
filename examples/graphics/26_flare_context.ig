// 26_flare_context.ig — RIGHT-CLICK context menus + hover TOOLTIPS on Flare (MANIFESTO §5g). Right-click
...
//
//   make graphics && build/inglec-gfx --emit=run examples/graphics/26_flare_context.ig
